report 50023 "Sales Summary"
{
    Caption = 'Sales Summary';
    UsageCategory = Administration;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\R50023 Sales Summary.rdl';
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            RequestFilterFields = "No.", "Posting Date", "Virtual Sales", "Customer Posting Group";
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(StatusExists; StatusExists) { }
                trigger OnAfterGetRecord()
                var
                    SalesOrderstaging: Record "Sales Order Staging";
                begin
                    SalesOrderstaging.Reset();
                    SalesOrderstaging.SetRange(OrderNo, "SOMS Order No.");
                    SalesOrderstaging.SetRange(SHIPNO, "SOMS Ship No");
                    SalesOrderstaging.SetRange(statusId, '50');
